            ...
            <div>
                <h2 className="text-xl relative z-20 md:text-4xl lg:text-5xl 2xl:text-7xl font-bold  text-center text-black dark:text-white font-sans tracking-tight w-full">
                    ...
                    <div className="relative mx-auto inline-block w-max [filter:drop-shadow(0px_1px_3px_rgba(27,_37,_80,_0.14))]">
                        ...
                        <Link to='/allCars'><button className="btn shadow-lg shadow-black/30 border-none hover:btn-secondary bg-blue-600 text-lg font-semibold text-white">Book Now</button>
                        </Link>
                    </div>
                </h2>
            </div>
